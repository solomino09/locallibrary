...
from .models import Book, Author, BookInstance, Genre, Libraries
...
def index(request):
    ...
    num_libraries=Libraries.objects.all().count()
...
class LibrariesListView(generic.ListView):
    """
    Generic class-based list view for a list of libraries.
    """
    model = Libraries
    paginate_by = 10


class LibrariesDetailView(generic.DetailView):
    """
    Generic class-based detail view for an libraries.
    """
    model = Libraries
